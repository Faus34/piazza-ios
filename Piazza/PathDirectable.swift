...
protocol PathDirectable where Self: RoutingController { func executePathDirective(_ proposal: VisitProposal) }
...
extension VisitProposal {
    var isPathDirective: Bool { return url.path.contains("_historical_location") }
}
